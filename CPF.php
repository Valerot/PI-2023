...
if (isset($_POST['submit'])) {
    ...
    $mandarparaobanco = mysqli_query($conexao, "INSERT INTO universide_db(nome,sobrenome,pagamento,email,endereco,certificado,pais,estado,cep) VALUES ('$nome','$sobrenome','$pagamento','$email','$endereco','$certificado','$pais','$estado','$cep')");
  ...
  <nav class="site-header sticky-top py-1" style="background-color: rgba(245, 245, 0, 0.225);">
    ...
    <div class="container">
      <div class="py-5 text-center">
        <img src="images/CPF.png" alt="IMAGEM PARA CERTIFICADO DE PESSOAS JÚRIDICAS">
      ...
      <footer class="my-5 pt-5 text-muted text-center text-small">
        <p class="mb-1">© 2022-2023 MF Certificados</p>
